...
public class SmsApi {
    // api key
    private static final String HY_SMS_API_KEY = "8bef991ae1df016d9788d8c531904bac";
    // sms label
    public static final String HY_SMS_DEFAULT_LABEL = "【和也健康科技】";
     ...
     */
    public static void testDemo(String[] args) throws IOException,
            URISyntaxException {
     ...
     * @param text      短信内容
     * @param mobile    接受的手机号
     * @return SmsApiResult     may be null
     */
    public static SmsApiResult sendSms(String text, String mobile) {
        String result = sendSms(HY_SMS_API_KEY, text, mobile);
        return JSON.parseObject(result, SmsApiResult.class);
    }
     ...
     * @throws IOException
     */
    public static String tplSendSms(String apikey, long tplId, String tplValue,
